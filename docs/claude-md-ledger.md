...
## Certification protocol rules — the full corpse stories, moved 2026-08-14 (rules kept in CLAUDE.md)
...
## ⭐ CURRENT STATE archive — completed-batch narratives + superseded release chain, moved 2026-08-14 (live state kept in CLAUDE.md)
