...
- **INBOX_READ_TOKEN expires 2026-11-11** (the Pulse render's read-only PAT, rotated 2026-08-13 — the prior token died 2026-08-13 despite a recorded 2026-10-12 expiry, so trust the mint date + 90 days, not old notes; rotation is a 5-minute chore per docs/pulse-pipeline-runbook.md; the render workflow self-warns within 14 days).
