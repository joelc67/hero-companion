...
SCENARIOS = {
    ...
    "team":      dict(end_relief=0.25, enemies=8,  enemy_dps=90,  teammates=7, team_dps=110, length=25.0,  shift=2, rank_acc=1.10, ctrl_land=0.92, debuff_res=0.0,  enemy_regen=8,   def_debuff_in=0.04, kb_in=0.05, slow_in=0.08),
    "itrial":    dict(end_relief=0.5, enemies=10, enemy_dps=130, teammates=7, team_dps=130, length=30.0,  shift=3, rank_acc=1.20, ctrl_land=0.87, debuff_res=0.0,  enemy_regen=15,  def_debuff_in=0.07, kb_in=0.06, slow_in=0.15),
    ...
    "av":        dict(end_relief=0.5, enemies=1,  enemy_dps=220, teammates=0, team_dps=0,   length=240.0, shift=2, rank_acc=1.50, ctrl_land=0.08, debuff_res=0.85, enemy_regen=120, def_debuff_in=0.10, kb_in=0.03, slow_in=0.10),
}
