...
SCENARIOS = {
    ...
    "farm_active": dict(enemies=10, enemy_dps=110, teammates=0, team_dps=0, length=20.0,  shift=4, rank_acc=1.00, ctrl_land=0.95, debuff_res=0.0,  enemy_regen=5,   def_debuff_in=0.05, kb_in=0.02, slow_in=0.0),
