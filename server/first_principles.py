...
SCENARIOS = {
    ...
    "farm_afk":  dict(dmg_type="Fire", enemies=27, enemy_dps=110, teammates=0, team_dps=0,   length=60.0,  shift=4, rank_acc=1.00, ctrl_land=0.95, debuff_res=0.0,  enemy_regen=5,   def_debuff_in=0.05, kb_in=0.02, slow_in=0.0),
...
def afk_sustain_assessment(powers, totals, arch_row, ctx, role_output_mod=None,
    ...
    if role_output_mod:
        ...
        for p in (powers or []):
            ...
            if (not _attack_claims_autofire and not interruptible
                    and rate > auto_hps):
